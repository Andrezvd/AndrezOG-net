...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> entity)
    {
        ...
        entity.Property(e => e.Role).IsRequired().HasConversion<string>().HasColumnName("role");
        ...
        entity.Property(e => e.Provider).IsRequired().HasConversion<string>().HasColumnName("provider");
